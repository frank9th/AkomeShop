...
class OrderAdmin(admin.ModelAdmin):
	list_display = ['customer', 'is_ordered', 'refund_requested', 'refund_granted', 'status', 'billing_address', 'amount', 'coupon', 'date_created']
	list_filter = [ 'is_ordered', 'refund_requested', 'refund_granted', 'status']
	list_display_links=['customer','billing_address', 'amount', 'coupon']
